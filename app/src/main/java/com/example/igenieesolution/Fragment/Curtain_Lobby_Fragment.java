...
import com.example.igenieesolution.databinding.FragmentCurtainLobbyBinding;

public class Curtain_Lobby_Fragment extends Fragment {
    FragmentCurtainLobbyBinding binding;
